...
class boss(pygame.sprite.Sprite):
    def __init__(self):
        ...
        image = pygame.image.load("boss_no_rockets.png").convert_alpha()
        self.left_frames.append(image)
        image = pygame.image.load("boss.png").convert_alpha()
        self.left_frames.append(image)
        image = pygame.image.load("boss_no_rockets.png").convert_alpha()
    ...
    def follow(self, player,items):
        ...
        #left down
            ...
            self.moveleft()
            self.movedown()
        elif player.rect.x in range(self.rect.x-200,self.rect.x+100) and player.rect.y in range(self.rect.y-10, self.rect.y+300):
            self.stop()
